...
export function AuthLayout() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background font-sans overflow-hidden">
      ...
      <div className="relative flex w-full flex-col justify-center items-center bg-gradient-to-br from-background via-muted/40 to-background px-4 lg:w-[45%] overflow-hidden">
        ...
        <div className="w-full max-w-[440px] z-10">
          <div className="rounded-3xl border border-white/20 dark:border-white/10 bg-card/60 backdrop-blur-xl p-8 md:p-10 shadow-2xl relative overflow-hidden transition-all duration-300 hover:shadow-primary/5">
